...
<html lang="en" dir="ltr">
	...
	<div class="welcome">
	<span style="font-size:35px; color: white; background-color: purple;">Welcome, <?php echo "manager ";echo $_SESSION['logged_name']; ?>					<?php ?></span>
	</div>
	...
	<div class="stockupdated">
				<span style="color:white; font-size:35px; margin-left:45%; background-color: purple; margin-left:45%;">Stock Updated!</span><br>
