...
<br />
<div class="next_btn">
    <button class="buttonHover2" type="submit"  style="height:70px; width:450px; font-size: 25px; border-radius:5px; border: 2px solid red; margin-left:1px;">Συνέχεια</button>
</div>
